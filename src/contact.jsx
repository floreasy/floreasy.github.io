    function ContactPage() {
      ...
      const formulesList = [
        ...
        { k: "a1", label: "+ Atelier · Déconstruire les stéréotypes de genre (1 à 2h)" },
        { k: "a2", label: "+ Atelier · Diversité et inclusion (1 à 2h)" },
        { k: "a3", label: "+ Atelier · Agir pour l’égalité (1 à 2h)" },
      ];
    ...
    if (typeof document === "undefined") {
      ...
      if (racine.firstChild) ReactDOM.hydrateRoot(racine, <ContactPage />);
      else ReactDOM.createRoot(racine).render(<ContactPage />);
    }
